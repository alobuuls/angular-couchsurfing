...
@Component({
  selector: 'hosted-trip-form',
  templateUrl: './hosted-trip-form.component.html',
  styleUrls: ['./hosted-trip-form.component.css'],
})
export class HostedTripFormComponent implements OnInit {
