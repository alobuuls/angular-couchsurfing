...
@Component({
  ...
  templateUrl: './hosted-form.component.html',
  styleUrls: ['./hosted-form.component.css'],
})
export class HostedFormComponent implements OnChanges {
  @ViewChild(HostedTripFormComponent) tripFormComponent!: HostedTripFormComponent;
  @ViewChildren(HostedIndividualFormComponent) guestForms!: QueryList<HostedIndividualFormComponent>;
